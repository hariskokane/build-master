      ...
      <div className="p-6 space-y-6">
        ...
        <div className="relative bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 rounded-3xl p-8 text-white overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-3xl font-bold mb-2">Welcome to Budget Master!</h1>
            <p className="text-purple-100 text-lg">Your journey to financial freedom starts here</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-semibold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-4">Get Started with Your Finances</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 flex items-center gap-3 justify-center shadow-lg font-medium"
            >
            ...
            <button 
              ...
              className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl hover:bg-gradient-to-r hover:from-gray-50 hover:to-slate-50 hover:border-gray-400 transition-all duration-200 flex items-center gap-3 justify-center font-medium"
            >
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="relative bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 rounded-3xl p-6 text-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-purple-100">Overview of your financial status</p>
        </div>
      </div>
