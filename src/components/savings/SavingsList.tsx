...
export const SavingsList: React.FC<SavingsListProps> = ({ 
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="relative bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 rounded-3xl p-8 text-white overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Savings Goals Hub</h1>
            <p className="text-teal-100 text-lg">Dream big, save smart, achieve more</p>
          </div>
          <button
      ...
      {savingsGoals.length === 0 && (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No savings goals yet</h3>
            <p className="text-gray-500 mb-6">Start building your future by setting your first savings goal</p>
            <button
              onClick={() => setIsFormOpen(true)}
              className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-6 py-3 rounded-xl hover:from-teal-700 hover:to-cyan-700 transition-all duration-200 font-medium shadow-lg"
            >
